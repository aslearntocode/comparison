...
const faqStructuredData = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "How do I decide between breaking my FD and taking a loan?",
      "acceptedAnswer": {"@type": "Answer", "text": "Compare the interest you pay on the loan with the interest you earn on your FD. If the loan interest is higher, it may make sense to break the FD."}
    },
    {
      "@type": "Question",
      "name": "What factors should I consider before breaking my FD?",
      "acceptedAnswer": {"@type": "Answer", "text": "Consider penalty charges, loss of interest, and your liquidity needs before breaking your FD."}
    }
  ]
};
  ...
  return (
    <>
      <Head>
        ...
        <Script type="application/ld+json" id="structured-data" dangerouslySetInnerHTML={{ __html: JSON.stringify(structuredData) }} />
        <Script type="application/ld+json" id="faq-structured-data" dangerouslySetInnerHTML={{ __html: JSON.stringify(faqStructuredData) }} />
      </Head>
        ...
        <main>
          <section aria-label="Article Header" className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-12">
            <div className="max-w-6xl mx-auto px-4">
              <h1 className="text-4xl font-bold mb-4">Loan vs FD Calculator</h1>
          ...
          <div className="max-w-6xl mx-auto px-4 py-8">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 mb-8">
              <h2 className="text-2xl font-bold mb-4">Should You Break Your FD to Repay a Loan?</h2>
              <p className="text-gray-700">Compare your loan interest payments with FD returns to make an informed decision. Enter your loan and FD details below to see which option is financially better for you.</p>
            ...
            <section aria-label="Frequently Asked Questions" className="mt-12">
              ...
              <div className="space-y-6">
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                  <h3 className="font-semibold text-lg mb-2">How do I decide between breaking my FD and taking a loan?</h3>
                  <p className="text-gray-700">Compare the interest you pay on the loan with the interest you earn on your FD. If the loan interest is higher, it may make sense to break the FD.</p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                  <h3 className="font-semibold text-lg mb-2">What factors should I consider before breaking my FD?</h3>
                  <p className="text-gray-700">Consider penalty charges, loss of interest, and your liquidity needs before breaking your FD.</p>
                </div>
              </div>
            </section>
          </div>
