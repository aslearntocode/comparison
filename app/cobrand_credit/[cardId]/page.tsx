      ...
      <div className="min-h-screen flex flex-col bg-gray-50">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href="/cobrand_credit" className="text-blue-600 hover:text-blue-800">
              Back to Co-Branded Credit Cards
            </Link>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-6">
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <RewardPointsCard bank={card.bank} cardId={card.id} />
              </div>
            </div>
          </div>
        );
    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="bg-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-4">
            <Link href="/cobrand_credit" className="text-white flex items-center gap-2">
